  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.skillsRow}>
        <SkillBar skillName="Problem Solving" currentXP={60} maxXP={100} color="#FF8460" />
        <SkillBar skillName="Communication" currentXP={80} maxXP={100} color="#4CA8FF" />
      </View>
      <View style={styles.skillsRow}>
        <SkillBar skillName="Adaptability" currentXP={40} maxXP={100} color="#FFAB45" />
        <SkillBar skillName="Leadership" currentXP={60} maxXP={100} color="#6CE7C9" />
      </View>
  ...
  return (
    <View style={styles.skillContainer}>
      ...
      <View style={styles.progressBar}>
        <View style={[styles.progress, { width: barWidth, backgroundColor: color }]} />
      </View>
      <Text style={[styles.xpText, { color }]}>{`${currentXP}/${maxXP} XP`}</Text>
    </View>
  );
};
